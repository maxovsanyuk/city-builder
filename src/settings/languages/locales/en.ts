const translations = {
  ...
  'most.popular.entrepreneurs.categories.requests': 'Most popular entrepreneurs categories requests',
  'most.popular.citiziens.categories.requests': 'Most popular citiziens categories requests',
  'country.category': 'Country category',
  advertisement: 'Advertisement',
  'entrepreneur.requests': 'entrepreneur requests',
