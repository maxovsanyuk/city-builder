...
const CountryCategoryPageEntrepreneurRequestsContent = () => {
  ...
  return (
    <Wrapper>
      <Typography variant="h4" className="title">
        {formatMessage({ id: 'country' })} {formatMessage({ id: `category.${categoryId}` })} {formatMessage({ id: 'entrepreneur.requests' })}
      </Typography>
...
export default CountryCategoryPageEntrepreneurRequestsContent
