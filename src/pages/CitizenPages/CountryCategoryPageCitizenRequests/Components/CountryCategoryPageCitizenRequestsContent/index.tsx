...
const CountryCategoryPageCitizenRequestsContent = () => {
  ...
  return (
    <Wrapper>
      <Typography variant="h4" className="title">
        {formatMessage({ id: 'country' })} {formatMessage({ id: `category.${categoryId}` })} {formatMessage({ id: 'citizen.requests' })}
      </Typography>
...
export default CountryCategoryPageCitizenRequestsContent
